...
class ExplainBTPlugin(Plugin):
    ...
    def _handle_explanations_callback(self, explanations_msg):
        self.update_text_signals[0].update_text_signal.emit(explanations_msg.what_is_next_action_if_success)
        self.update_text_signals[1].update_text_signal.emit(explanations_msg.what_is_next_action_if_fail)
        self.update_text_signals[2].update_text_signal.emit(explanations_msg.what_are_current_pre_conditions)
        self.update_text_signals[3].update_text_signal.emit(explanations_msg.what_are_current_post_conditions)
