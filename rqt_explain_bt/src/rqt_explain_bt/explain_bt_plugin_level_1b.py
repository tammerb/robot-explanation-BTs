...
class ExplainBTPlugin(Plugin):
    ...
    def _handle_explanations_callback(self, explanations_msg):
        self.update_text_signals[0].update_text_signal.emit(explanations_msg.how_do_you_achieve_your_goal)
        self.update_text_signals[1].update_text_signal.emit(explanations_msg.how_do_you_achieve_your_subgoal)
