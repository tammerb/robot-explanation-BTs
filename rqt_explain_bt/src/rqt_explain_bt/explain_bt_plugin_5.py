...
class ExplainBTPlugin(Plugin):
    def __init__(self, context):
        ...
        button_names = ['Start', 'Pause', 'Reset']
        ...
        # Create a grid layout for the 2x6 grid
        questions = [
            "What is your goal?",
    ...
    def _handle_explanations_callback(self, explanations_msg):
        self.update_text_signals[0].update_text_signal.emit(explanations_msg.what_is_your_goal)
        self.update_text_signals[1].update_text_signal.emit(explanations_msg.how_do_you_achieve_your_goal)
        ...
        self.update_text_signals[4].update_text_signal.emit(explanations_msg.what_are_you_doing)
        self.update_text_signals[5].update_text_signal.emit(explanations_msg.why_are_you_doing_this)
        self.update_text_signals[6].update_text_signal.emit(explanations_msg.what_is_next_action_if_success)
        self.update_text_signals[7].update_text_signal.emit(explanations_msg.what_is_next_action_if_fail)
        self.update_text_signals[8].update_text_signal.emit(explanations_msg.what_are_current_pre_conditions)
        self.update_text_signals[9].update_text_signal.emit(explanations_msg.what_are_current_post_conditions)
        self.update_text_signals[10].update_text_signal.emit(explanations_msg.what_went_wrong)
